...
class Context(Resource):
    ...
    def post(self):
        ...
        return {'status': _context.create_insert(text=args['text'], subject=args['subject'])}
...
class Context(Resource):
    ...
    def delete(self, _id):
        return {'status': _context.collection.delete_one({'_id': _id})}
    ...
    def patch(self, _id):
        ...
        return {'status': _context.collection.update_one({'_id': _id}, update=target)}
...
class Context(Resource):
    ...
    def delete(self, subject):
        return {'status': _context.collection.delete_one({'subject': subject})}
    ...
    def patch(self, subject):
        ...
        return {'status': _context.collection.update_one({'subject': subject}, update=target)}
